...
{
    public static void SeedRoles(RoleManager<IdentityRole> roleMgr)
    {
        var roles = new[] { "Admin", "User" };

        foreach (var role in roles)
        {
            var roleExist = roleMgr.RoleExistsAsync(role).Result;
            if (!roleExist)
            {
    ...
    public static void EnsureSeedDataAsync(WebApplication app)
    {
